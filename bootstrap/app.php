...
$app->booted(function () {
    ...
    // مساعد المريض النصّي: حدّ مخصّص أضيق من 'api' العام.
    // السبب: كل طلب قد يستدعي خدمة AI خارجية (تكلفة tokens + زمن استجابة)،
    // ولا يجوز أن يكون استهلاكه بسقف 60/دقيقة المخصّص للقراءة العادية.
