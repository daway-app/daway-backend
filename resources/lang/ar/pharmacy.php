...
return [
    ...
    'profile' => [
        ...
        'complete' => [
            ...
            'location_default_hint' => 'الموقع مضبوط مبدئياً على مركز المدينة. تقدر تعدّله بدقة من صفحة «تعديل الملف» بعد إكمال البيانات.',
    ...
    // تغيير كلمة المرور المؤقتة — مفروض على أول دخول لصيدلية أنشأها الأدمن.
    'password' => [
        'change' => [
            'title' => 'تغيير كلمة المرور',
            'heading' => 'عيّن كلمة مرور جديدة',
            'subtitle' => 'كلمة المرور الحالية مؤقتة سلّمها لك مدير النظام. لأمان حسابك، يجب تغييرها قبل المتابعة.',
            ...
            'hero_desc' => 'كلمة مرور قوية تحمي مخزون صيدليتك وبياناتك. أنشئها الآن وستُستخدم عند كل دخول.',
