...
return [
    ...
    // --- حد المعدل (HTTP 429) ---
    // الحد يحرس الأفعال (رفع/قرارات/تنفيذ/إلغاء) لا فتح الصفحة.
    'error_too_many_requests' => 'تجاوزت الحد المسموح من عمليات الاستيراد. يمكنك المحاولة مرة أخرى بعد :seconds ثانية.',
    'error_too_many_requests_generic' => 'تجاوزت الحد المسموح من عمليات الاستيراد. حاول مرة أخرى بعد قليل.',
    'rate_limit_remaining' => 'عمليات الاستيراد المتبقية خلال الساعة: :count من :limit.',
    'rate_limit_exhausted' => 'استنفدت حصتك من عمليات الاستيراد. تتجدد تلقائياً بعد :minutes دقيقة — لا حاجة لإعادة تحميل الصفحة.',
    'rate_limit_retrying' => 'تجاوزت الحد المسموح — نعيد المحاولة تلقائياً بعد :seconds ثانية…',
