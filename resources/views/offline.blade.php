...
<head>
    ...
    <style>
        ...
        .offline-box .icon{width:64px;height:64px;border-radius:9999px;background:#E3F0F8;color:#1C72A6;display:grid;place-items:center;font-size:1.6rem;margin:0 auto 18px;}
        ...
        .offline-box button{background:#1C72A6;color:#fff;border:none;border-radius:12px;padding:12px 28px;font-weight:600;font-size:.95rem;cursor:pointer;font-family:inherit;}
        .offline-box button:hover{background:#155E85;}
    </style>
</head>
<body>
