...
@section('content')
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div>
                <h2 class="pharmacy-page-title">{{ $pharmacy->pharmacy_name }}</h2>
            ...
            <div class="form-card" style="margin-bottom: 0;">
                ...
                <div class="form-card-body" style="padding: 24px;">
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                        <div>
                            <div class="info-label">@lang('pharmacies.pharmacy_address_display')</div>
                            <div class="info-value">{{ $pharmacy->address }}</div>
                        </div>
                        <div>
                            <div class="info-label">@lang('pharmacies.pharmacy_phone_display')</div>
                            <div class="info-value">{{ $pharmacy->phone_number }}</div>
                        </div>
                        <div>
                            <div class="info-label">@lang('pharmacies.owner_email')</div>
                            <div class="info-value">{{ $pharmacy->user->email ?? 'N/A' }}</div>
                        </div>
                        <div>
                            <div class="info-label">@lang('pharmacies.col_last_activity')</div>
                            <div class="info-value">{{ $pharmacy->updated_at->diffForHumans() }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card" style="margin-bottom: 0;">
                ...
                <div class="form-card-body" style="padding: 24px; display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 1.6rem; font-weight: 800; color: #10b981;">{{ $availabilityRate }}%</div>
                    </div>
                </div>
            </div>
        </div>
