...
@section('content')
                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="fg">
                            ...
                            <div class="fc-icon">
                                <span class="ico">📱</span>
                                <input class="fc" type="tel" name="phone_number" placeholder="@lang('pharmacies.phone_number_placeholder')" value="{{ old('phone_number') }}" required>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="fg">
                            ...
                            <input class="fc" type="text" name="address_line" placeholder="@lang('pharmacies.address_line_placeholder')" value="{{ old('address_line') }}" required>
                        ...
                        <div class="fg">
                            ...
                            <select class="fc" name="city" required>
                                ...
                                <option value="Gaza" {{ old('city') == 'Gaza' ? 'selected' : '' }}>@lang('pharmacies.city_gaza')</option>
                                <option value="Khan Yunis" {{ old('city') == 'Khan Yunis' ? 'selected' : '' }}>@lang('pharmacies.city_khan_yunis')</option>
                                <option value="Rafah" {{ old('city') == 'Rafah' ? 'selected' : '' }}>@lang('pharmacies.city_rafah')</option>
                                <option value="Deir al-Balah" {{ old('city') == 'Deir al-Balah' ? 'selected' : '' }}>@lang('pharmacies.city_deir_al_balah')</option>
                                <option value="North" {{ old('city') == 'North' ? 'selected' : '' }}>@lang('pharmacies.city_north')</option>
                                <option value="Nablus" {{ old('city') == 'Nablus' ? 'selected' : '' }}>@lang('pharmacies.city_nablus')</option>
                                <option value="Ramallah" {{ old('city') == 'Ramallah' ? 'selected' : '' }}>@lang('pharmacies.city_ramallah')</option>
                                <option value="Hebron" {{ old('city') == 'Hebron' ? 'selected' : '' }}>@lang('pharmacies.city_hebron')</option>
                            </select>
                    ...
                    <div class="fg">
                        ...
                        <input class="fc" name="area" placeholder="@lang('pharmacies.area_placeholder')" value="{{ old('area') }}">
                    ...
                    <div class="fg">
                        ...
                        <div style="display: flex; gap: 10px; margin-bottom: 8px;">
                            <input class="fc" type="text" id="latitude" name="latitude" placeholder="@lang('pharmacies.latitude_placeholder')" value="{{ old('latitude') }}" readonly style="background: #f8fafc;">
                            <input class="fc" type="text" id="longitude" name="longitude" placeholder="@lang('pharmacies.longitude_placeholder')" value="{{ old('longitude') }}" readonly style="background: #f8fafc;">
                        </div>
                        <div id="map"></div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            var defaultLat = {{ old('latitude', 31.5016) }};
            var defaultLng = {{ old('longitude', 34.4668) }};
